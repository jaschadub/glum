...
impl Grammar {
    fn for_lang(raw: &str) -> Option<&'static Self> {
        ...
        let key = lang.split(|c: char| c == ',' || c.is_whitespace()).next().unwrap_or("");
        match key {
            "rust" | "rs" => Some(&RUST),
...
static RUST: Grammar = Grammar {
    ...
    types: &[
        ...
        "Result", "Box", "Rc", "Arc", "HashMap", "BTreeMap",
    ],
    line_comments: &["//"],
    strings: &['"'],
    case_sensitive: true,
...
static JS: Grammar = Grammar {
    keywords: &[
        ...
        "for", "function", "if", "import", "in", "instanceof", "interface", "let", "new", "null",
        "of", "return", "static", "super", "switch", "this", "throw", "true", "try", "type",
        "typeof", "undefined", "var", "void", "while", "with", "yield",
    ],
    types: &["boolean", "number", "string", "object", "symbol", "bigint", "any", "unknown", "never", "void"],
    line_comments: &["//"],
    strings: &['"', '\'', '`'],
    case_sensitive: true,
    fn_call_highlight: true,
...
static C: Grammar = Grammar {
    ...
    types: &[
        ...
        "size_t", "ssize_t", "ptrdiff_t", "intptr_t", "uintptr_t", "bool", "FILE",
    ],
    line_comments: &["//"],
    strings: &['"', '\''],
    case_sensitive: true,
...
static CPP: Grammar = Grammar {
    keywords: &[
        ...
        "else", "enum", "explicit", "export", "extern", "false", "final", "float", "for",
        "friend", "goto", "if", "inline", "int", "long", "mutable", "namespace", "new", "noexcept",
        "not", "nullptr", "operator", "override", "private", "protected", "public", "register",
...
static JAVA: Grammar = Grammar {
    keywords: &[
        ...
        "throw", "throws", "transient", "true", "false", "try", "void", "volatile", "while", "var",
    ],
    types: &["String", "Integer", "Long", "Double", "Float", "Boolean", "List", "Map", "Set", "Object"],
    line_comments: &["//"],
    strings: &['"', '\''],
    case_sensitive: true,
    fn_call_highlight: true,
...
fn scan(line: &str, g: &'static Grammar, theme: Theme) -> Vec<Span<'static>> {
    ...
    for prefix in g.line_comments {
        ...
        if trimmed.starts_with(prefix) {
            ...
            spans.push(Span::styled(line[indent_len..].to_string(), theme.comment_style()));
            return spans;
        }
    }
