...
with `GLUM_PREFIX=/usr/local`, pin a version with `GLUM_VERSION=v0.4.0`.
...
curl -LO https://github.com/jaschadub/glum/releases/latest/download/glum_0.4.0-1_amd64.deb
sudo apt install ./glum_0.4.0-1_amd64.deb

# Fedora / RHEL / openSUSE
sudo dnf install https://github.com/jaschadub/glum/releases/latest/download/glum-0.4.0-1.x86_64.rpm
```
